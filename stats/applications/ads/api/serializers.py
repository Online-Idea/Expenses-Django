...
class AdSerializer(serializers.ModelSerializer):
    ...
    mark_name: serializers.StringRelatedField = serializers.StringRelatedField(source='mark.mark', read_only=True)

    # Кастомное поле для отображения имени модели
    model_name: serializers.StringRelatedField = serializers.StringRelatedField(source='model.model', read_only=True)

    # Кастомное поле для вычисляемой цены
    good_price: serializers.SerializerMethodField = serializers.SerializerMethodField()

    # Кастомное поле для отображения цены
    price_display: serializers.SerializerMethodField = serializers.SerializerMethodField()

    # Кастомное поле для отображения абсолютного URL
    absolute_url: serializers.SerializerMethodField = serializers.SerializerMethodField()

    # Кастомное поле для отображения цены с НДС
    price_nds_display: serializers.SerializerMethodField = serializers.SerializerMethodField()

    # Кастомное поле для отображения модификации
    modification_display: serializers.SerializerMethodField = serializers.SerializerMethodField()

    # Кастомное поле для отображения доступности
    availability_display: serializers.SerializerMethodField = serializers.SerializerMethodField()

    # Кастомное поле для отображения первой фотографии
    first_photo: serializers.SerializerMethodField = serializers.SerializerMethodField()

    # Кастомное поле для отображения пробега
    run_display: serializers.SerializerMethodField = serializers.SerializerMethodField()
